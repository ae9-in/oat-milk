...
>(
  (
    ...
    const resolvedWhileInView = whileInView !== undefined
      ? whileInView
      : (animate ? undefined : "visible")
...
>(({ style, className, alt, ...props }, ref) => {
  ...
  return (
    <motion.img
      ...
      alt={alt}
      className={cn(
        "relative z-10 size-auto max-h-full max-w-full object-cover",
        className
      )}
      style={{ scale, ...style }}
      {...props}
