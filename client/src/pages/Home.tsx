...
export default function Home() {
  ...
  // Testimonial state removed - managed internally by AnimatedTestimonials
  ...
  // Testimonial auto-rotate removed - managed internally by AnimatedTestimonials
  ...
  // Testimonial navigation removed - managed internally by AnimatedTestimonials
    ...
    <div ref={containerRef} className="min-h-screen bg-cream-base">
      ...
      {showLoader && (
        <div className={`loading-screen ${loaderExiting ? 'loader-exit' : ''}`}>
          {/* Custom concentric ring loader from Uiverse.io */}
